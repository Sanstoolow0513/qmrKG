...
Modern course teaching materials are predominantly distributed as unstructured documents such as PDF (Portable Document Format) and PPT (PowerPoint) files, yet such documents are dominated by specialized terms and cross-chapter relations, making manual knowledge graph construction costly and hard to scale. This work automates knowledge graph construction from unstructured course materials with large language models (LLMs).
